...
print("\n-|-MISSION01-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|")
amp_computer_name = "Demo_AMP_Threat_Audit"
...
def get_amp_events(query_params="",
    ...
    """Step 2 : Get a list of recent events from Cisco Secure Endpoint."""
...
def get_umbrella_domain_status(domains,
    ...
    if headers== {'MISSION09':'MISSION09'}:
        ...
        print(yellow("\nYou can search for similar declaration for hearders in this code  ",bold=True))          
        env.print_missing_mission_warn(env.get_line())  
...
if __name__ == "__main__":  
    ...
    """
    Step 3. In Malware Analytics, find all samples, associated with malicious sha256 that you have 
    ...
    if 'MISSION05' in submission_info:
        ...
        print(yellow("\nThe function that Search TreatGrid Submissions by sha256",bold=True))
    ...
    """
    Step 4. Request all domains for a specific sample in Malware Analytics and store them in an array to get more data out of them.
    """
    print(white(f"\nCOMPLETION 35 %"))
    ...
    umbrella_domains_status = get_umbrella_domain_status(threatgrid_sample_domains)
    ...
    """
    Step 7. Using Umbrella Enforcement, post malware events to the API for processing and optionally adding to a customer's domain lists.
    """
    ...
    """
    Step 8. Using XDR Threat Response, inspect if malicious sha256 has been found on our network. 
    ...
    ctr_arb_text = """The Young Brown Fox Jumped {b1380fd95bc5c0729738dcda2696aa0a7c6ee97a93d992931ce717a0df523967} over the Lazy dog
...
"""
    ...
    """
    Step 8. Use response capabilities of Secure Endpoint module in CTR to block this malicious file from execution on all Computers in our network.
    """
    ...
    if 'MISSION15' in response_actions:
        ...
        print(yellow("MISSION15 : Then call it with the correct input variables",bold=True))
